...
setTimeout(() => {
	...
	document.querySelector("#counters").textContent = ("СДЕЛАНО КЛИКОВ: " + formatter(counters));
...
// From 0.001 to 100
const items = [
  {name: 'rabbit', img: 'img/rabbit.png', chance: 1},
  {name: 'duck', img: 'img/chiken6.png', chance: 2},
