...
function saveMain() {
	...
	localStorage.setItem('chiken', parseInt(chiken));
	localStorage.setItem('quest1', parseInt(quest1));
	localStorage.setItem('quest2', parseInt(quest2));
	localStorage.setItem('quest3', parseInt(quest3));
}
